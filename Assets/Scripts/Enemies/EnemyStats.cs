...
public class EnemyStats : MonoBehaviour
{
    ...
    public int level = 1;
    public bool isFinalBoss = false;          // ao morrer, carrega a cena de vitória
    public string victorySceneName = "Vitoria"; // nome da cena de vitória

    [Header("Stats Base (n�vel 1)")]
    public int baseHealth = 100;
    public int baseDefense = 3;
    public int baseAttackPower = 10;
    public int baseXpReward = 50;

    [Header("Escalonamento por n�vel")]
    ...
    void Die()
    {
        ...
        if (isFinalBoss)
        {
            ...
            return; // a cena vai trocar, não precisa destruir
        }
