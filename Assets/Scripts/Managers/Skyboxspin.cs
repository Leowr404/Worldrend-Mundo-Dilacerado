...
public class Skyboxspin : MonoBehaviour
{
    ...
    [Header("Transi��es em MINUTOS de jogo")]
    [Tooltip("Dura��o da transi��o Noite -> Amanhecer (ex.: 30 = meia hora de jogo).")]
    ...
    void Update()
    {
        ...
        // minuto do dia (float) com fra��o
        float nowMin = CurrentMinutesOfDay();

        // atualiza skybox (blend cont�nuo) e luz
    ...
    void UpdateSkyboxBlend(float nowMin)
    {
        ...
        // blocos de transi��o por janela de minutos de JOGO
        ...
        // fora das janelas: fase est�vel (sem blend)
    ...
    /*private void UpdateSunDirection()
    {
        ...
        // Rota��o do sol (eleva��o). Ajuste o Y se quiser azimute fixo (ex.: 30f).
